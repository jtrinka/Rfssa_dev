...
server.mfssa <- function(input, output, clientData, session) {
  ...
  output$s.choice <- renderUI({
    ...
    if (!length(iXs())) {
      ...
      call=load_github_data("https://github.com/jtrinka/Rfssa_dev/blob/main/data/Callcenter")
      # load the Jambi data
      jambi=load_github_data("https://github.com/jtrinka/Rfssa_dev/blob/main/data/Jambi")
