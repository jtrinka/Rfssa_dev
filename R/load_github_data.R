...
#' @examples
#' \dontrun{
#' call = load_github_data("https://github.com/jtrinka/Rfssa_dev/blob/main/data/Callcenter.RData")
#' jambi = load_github_data("https://github.com/jtrinka/Rfssa_dev/blob/main/data/Jambi.RData")
#' montana = load_github_data("https://github.com/jtrinka/Rfssa_dev/blob/main/data/Montana.RData")
#'
#' }
#'
