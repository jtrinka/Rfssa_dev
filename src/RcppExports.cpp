...
RcppExport SEXP _Rfssa_AtimesB(SEXP cSEXP, SEXP ASEXP, SEXP BSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(AtimesB(c, A, B));
    return rcpp_result_gen;
END_RCPP
}
// EigenDecomp
Rcpp::List EigenDecomp(NumericMatrix A);
RcppExport SEXP _Rfssa_EigenDecomp(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type A(ASEXP);
    rcpp_result_gen = Rcpp::wrap(EigenDecomp(A));
    return rcpp_result_gen;
END_RCPP
}
// SS
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_Rfssa_AtimesB", (DL_FUNC) &_Rfssa_AtimesB, 3},
    {"_Rfssa_EigenDecomp", (DL_FUNC) &_Rfssa_EigenDecomp, 1},
